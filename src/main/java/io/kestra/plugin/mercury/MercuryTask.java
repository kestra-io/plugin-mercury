package io.kestra.plugin.mercury;
    ...
    examples = {
        @io.kestra.core.models.annotations.Example(
            ...
            code = """
                ...
                tasks:
                  - id: reverse
                    type: io.kestra.plugin.mercury.MercuryTask
                    format: "Text to be reverted"
                """
        )
    }
)
public class MercuryTask extends Task implements RunnableTask<MercuryTask.Output> {
    @Schema(
    ...
    @Override
    public MercuryTask.Output run(RunContext runContext) throws Exception {
